...
--
-- Host: localhost:3307
-- Generation Time: Mar 29, 2025 at 04:09 PM
...
(8, 'นาดี', 'งามยุ', '435 หมู่ 10 ต.บ้านเลื่อม อ.เมือง จ.อุดร', 'ไทย', '41000', '0834526493', 'jonut222@gmail.com', '123456789'),
(9, 'Thananan', 'Sangkamanee', '123/456', 'Thailand', '41000', '0899999999', 'thananan@miztycrew.com', '123456');
...
(3, '003', 'นายนุขิต เพชรไพบูรณ์', 'jonut@555.com', '0425846987', 'ขอให้รวย', 'uploads/98640163-4d7f-43ad-b9f7-4fa0e80b4634.jpg', '2025-02-19 21:53:17'),
(4, '004', 'นาดี งามยุ', 'jonut222@gmail.com', '0845237899', '', 'uploads/015051163617AOR05250.jpeg', '2025-02-20 14:28:37'),
(5, '004', 'นางยุพาดี หม่อนวิชิต', 'dfsdf@sdfsdf.com', '048523695', '', 'uploads/98640163-4d7f-43ad-b9f7-4fa0e80b4634.jpg', '2025-02-23 06:14:47');
...
(11, 9, 20000, 'กำลังตรวจสอบ', 'Feb 26, 2025'),
(53, 1, 18000, 'ชำระเงินแล้ว', 'Feb 19, 2025'),
(59, 1, 18000, 'กำลังตรวจสอบ', 'Feb 23, 2025'),
(60, 1, 0, 'กำลังตรวจสอบ', 'Feb 23, 2025'),
(871, 8, 40000, 'ชำระเงินแล้ว', 'Feb 20, 2025'),
(872, 1, 18000, 'กำลังตรวจสอบ', 'Feb 23, 2025'),
(7928, 1, 54000, 'กำลังตรวจสอบ', 'Feb 23, 2025');
...
(20, 53, 10, 1, NULL, NULL),
(21, 871, 10, 1, NULL, NULL),
(22, 871, 16, 1, NULL, NULL),
(23, 871, 29, 1, NULL, NULL),
(24, 0, 10, 1, NULL, NULL),
(25, 7928, 10, 3, NULL, NULL),
(26, 59, 10, 1, NULL, NULL),
(27, 11, 4, 1, NULL, NULL),
(28, 11, 20, 1, NULL, NULL);
...
--
ALTER TABLE `transaction`
  MODIFY `transaction_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7929;
