				...
				<div class="modal-header">
					...
					<form method="post">
						<center>
							<table>
								<tr>
									<td class="profile">ชื่อ:</td><td class="profile"><?php echo $fetch['firstname'];?>&nbsp;<?php echo $fetch['mi'];?>&nbsp;<?php echo $fetch['lastname'];?></td>
								</tr>
								<tr>
									<td class="profile">ที่อยู๋</td><td class="profile"><?php echo $fetch['address'];?></td>
								</tr>
								<tr>
...
<div id="container">
	<div class="nav">
			 <ul>
				...
				<li><a href="product1.php"> <i class="icon-th-list"></i>สินค้า</a></li>
				
			</ul>
	</div>

	<form method="post" class="well" style="background-color:#blue;">
	<table class="table">
	<label style="font-size:25px;">ตระกร้าสินค้า</label>
		<tr>
			<th><h3>รูปภาพ</h3></td>
			<th><h3>ชื่อสินค้า</h3></th>
			<th><h3>ไซต์</h3></th>
			<th><h3>จำนวน</h3></th>
			<th><h3>ราคา</h3></th>
			<th><h3>เพื่มรายการสินค้า</h3></th>
			<th><h3>ลบรายการสินค้า</h3></th>
			<th><h3>ราคารวม</h3></th>
		</tr>
...
if (isset($_SESSION['cart']))
	...
	$total=$total+$line_cost;
		...
		echo "<td><strong><h3>ราคา ".$line_cost."</h3></strong>";
		echo "</tr>";
		}
		...
		echo "<td></td>";
		echo "<td></td>";
		echo "<td><h2>ราคา:</h2></td>";
		echo "<td><strong><input type='hidden' value='".$total."' required name='total'><h2 class='text-danger'>ราคา ".$total."</h2></strong></td>";
		echo "<td></td>";
		echo "<td><a class='btn btn-danger btn-sm pull-right' href='cart.php?id=".$id."&action=empty'><i class='fa fa-trash-o'></i> ลบตะกร้าสินค้า</a></td>";
		echo "</tr>";
	}
 	else
		echo "<font color='#111' class='alert alert-error' style='float:right'>ไม่มีตะกร้าสินค้า</font>";
...
?>
	...
	<a href='home.php' class='btn btn-inverse btn-lg'>เลือกสินค้าเพื่ม</a>
	<?php echo "<button name='pay_now' type='submit' class='btn btn-inverse btn-lg' >จ่ายสินค้า</button>";
	...
	?>
		...
		<div id="purchase" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="width:400px;">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
				<h3 id="myModalLabel">การชำระเงิน</h3>
			</div>
				<div class="modal-body">
					<form method="post">
					<center>
						...
						<br/>
						<br/>
						<button class="btn btn-lg" >เงินสด</button>
					</center>
				</div>
			<div class="modal-footer">
				<button class="btn btn-danger" data-dismiss="modal" aria-hidden="true">ออก</button>
