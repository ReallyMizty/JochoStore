				...
				<div class="modal-header">
					...
					<form method="post">
						<center>
							<table>
								<tr>
									<td class="profile">ชื่อจริง</td><td class="profile"><?php echo $fetch['firstname'];?>&nbsp;<?php echo $fetch['mi'];?>&nbsp;<?php echo $fetch['lastname'];?></td>
								</tr>
								<tr>
...
<div id="container">
	<div class="nav">
		...
		?>
				<div>
					<center>
						...
						<h3 class="text-uppercase">ราคา <?php echo $row['product_price']?></h3>
						<h3 class="text-uppercase">ไซต์ <?php echo $row['product_size']?></h3>
						<?php echo "<a href='cart.php?id=".$id."&action=add'><input type='submit' class='btn btn-inverse' name='add' value='แอดสินค้า'></a> &nbsp;  <a href='product1.php'><button class='btn btn-inverse'>ย้อนกลับ</button></a> " ?>
					</center>
				</div>
		<?php }?>
			...
			<div class="modal-header">
				...
				<div class="modal-body">
					...
					<center>
						...
						<br />
						<h4>ราคารวม <?php echo $row['product_price']; ?> </h4>
						<br />
						<input type="checkbox" required>  <a href="#terms" data-toggle="modal"> </a> 
					</center>
				</div>
			<div class="modal-footer">
				<center>
					...
					<button class="btn btn-danger btn-mini" data-dismiss="modal" aria-hidden="true">ยกเลิก</button>
					</form>
			</div>
		</div>
		...
		<div id="terms" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="width:400px;">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
				<h3 id="myModalLabel">ระบบร้านขายรองเท้าผ้าใบออนไลน์</h3>
			</div>
				<div class="modal-body">
					<ul>
						<li></li>
	...
	<div id="footer">
		<div class="foot">
			...
			<div id="develop">
				<h4>ผู้พัฒนา</h4>
					<ul>
						<a href="#"><li>Thanatchai kananthong</li><a>
