...
<body>
	<div id="header">
		...
		<label>ร้านขายรองเท้าผ้าใบออนไลน์</label>
			...
			<ul>
				<li><a href="function/logout.php"><i class="icon-off icon-white"></i>ล๊อกเอาท์</a></li>
				...
				<div class="modal-header">
					...
					<form method="post">
						<center>
							<table>
								<tr>
									<td class="profile">ชื่อ:</td><td class="profile"><?php echo $fetch['firstname'];?>&nbsp;&nbsp;<?php echo $fetch['lastname'];?></td>
								</tr>
								<tr>
...
<div id="container">
	...
	<div id="content">
		<div class="nav">
			 ...
			 <ul>
                  <!-- ปุ่มที่จะแสดงหรือล่องหนตามสถานะการล็อกอิน -->
		...
		<div id="carousel">
			<div id="myCarousel" class="carousel slide">
				<div class="carousel-inner">
					...
					<div class="item" style="padding:0; border-bottom:0 solid #111;"><img src="img/b2.jpg" class="carousel"></div>
					<div class="item" style="padding:0; border-bottom:0 solid #111;"><img src="img/b3.jpg" class="carousel"></div>
				</div>
		...
		<div id="product" style="position:relative; margin-top:30%;">
			<center><h2><legend>รายการสินค้า</legend></h2></center>
			<br />
...
<div id="footer">
	<div class="foot">
		...
		<img src="img/addline.jpg"width=130,height 40>
		ติดต่อเราทีนี้
</div>
</div>
</body>
