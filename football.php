...
<div id="container">
	...
	<div class="nav1">
		<ul>
			...
			<li>|</li>
			<li><a href="football.php" class="active" style="color:#111;">รองเท้าฟุตบอล</a></li>
			<li>|</li>
			<li><a href="running.php">รองเท้าวิ่ง</a></li>
		</ul>
	</div>
	...
	<div id="footer">
		<div class="foot">
			...
			<p style="font-size:25px;"> ระบบร้านขายรองเท้าผ้าใบออนไลน์
		</div>
