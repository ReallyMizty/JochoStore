...
<div id="container">
	...
	<div class="nav">
		...
		<div class="nav1">
			<ul>
				<li><a href="product1.php" class="active" style="color:#111;">รองเท้าบาส</a></li>
				<li>|</li>
				<li><a href="football1.php">รองเท้าฟุตบอล</a></li>
				<li>|</li>
				<li><a href="running1.php">รองเท้าวิ่ง</a></li>
			</ul>
				<?php echo "<a href='cart.php?id=".$id."&action=view'><button class='btn btn-inverse' style='right:1%; position:fixed; top:10%;'><i class='icon-shopping-cart icon-white'></i> ตะกร้าสินค้า</button></a>" ?>
		</div>
