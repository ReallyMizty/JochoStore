...
<body>
	...
	<br>
		...
		<a href="#add" role="button" class="btn btn-info" data-toggle="modal" style="position:absolute;margin-left:222px; margin-top:140px; z-index:-1000;"><i class="icon-plus-sign icon-white"></i>แอดสินค้า</a>
		<div id="add" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="width:400px;">
				...
				<div class="modal-body">
					...
					<center>
						<table>
							...
							?>
							<tr>
								<td><input type="text" name="product_name" placeholder="ชื่อสินค้า" style="width:250px;" required></td>
							<tr/>
							<tr>
								<td><input type="text" name="product_price" placeholder="ราคา" style="width:250px;" required></td>
							</tr>
							<tr>
								<td><input type="text" name="product_size" placeholder="ไซต์" style="width:250px;" maxLength="2" required></td>
							</tr>
							<tr>
								<td><input type="text" name="brand" placeholder="ชื่อแบรนด์	" style="width:250px;" required></td>
							</tr>
							<tr>
								<td><input type="number" name="qty" placeholder="จำนวนสต็อก" style="width:250px;" required></td>
							</tr>
							<tr>
			...
			<input class="btn btn-primary" type="submit" name="add" value="แอดสินค้า">
...
<div id="leftnav">
	...
	<div id="rightcontent" style="position:absolute; top:10%;">
			<div class="alert alert-info"><center><h2>รองเท้าฟุตบอล</h2></center></div>
			<br />
				<label  style="padding:5px; float:right;"><input type="text" name="filter" placeholder="ค้นหาสินค้า" id="filter"></label>
			<br />
			...
			<table class="table table-hover" style="background-color:;">
				...
				<tr class="del<?php echo $id?>">
					...
					<?php
					echo "<a href='stockin.php?id=".$id."' class='btn btn-success' rel='facebox'><i class='icon-plus-sign icon-white'></i> เพื่มจำนวนสินค้า</a> ";
					echo "<a href='stockout.php?id=".$id."' class='btn btn-danger' rel='facebox'><i class='icon-minus-sign icon-white'></i> ลบรายการสินค้า</a>";
					?>
					</td>
				</tr>
				<?php
