...
<body>
	...
	<div id="rightcontent" style="position:absolute; top:10%;">
			<div class="alert alert-info"><center><h2>พัสดุ</h2></center></div>
		...
		<div class="alert alert-info">
			<table class="table table-hover" style="background-color:;">
				...
				<input type="submit" name="Submit2" value="แอดเลขพัสดุ" onclick='location.replace("addtrack.php")'>
	<input type="submit" name="Submit2" value="อัพเดทเลขพัสดุ" onclick='location.replace("uptrack.php")'>
				</tr>
				</thead>
				<?php
