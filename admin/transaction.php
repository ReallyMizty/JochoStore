...
<div id="leftnav">
	...
	<div id="rightcontent" style="position:absolute; top:10%;">
			<div class="alert alert-info"><center><h2>ธุรกรรม	</h2></center></div>
			<br />
				<label  style="padding:5px; float:right;"><input type="text" name="filter" placeholder="ค้นหา" id="filter"></label>
			<br />
			...
			<table class="table table-hover" style="background-color:;">
				...
				<tr>
					...
					<td><a href="receipt.php?tid=<?php echo $id; ?>">ใบเสร็จ</a>
					<?php
					if($o_stat == 'Confirmed'){
					...
					echo '| <a class="btn btn-mini btn-info" href="confirm.php?id='.$id.'">ยืนยัน</a> ';
					echo '| <a class="btn btn-mini btn-danger" href="cancel.php?id='.$id.'">ยกเลิก</a></td>';
					}
					?>
				</tr>
				<?php
