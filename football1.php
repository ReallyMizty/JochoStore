	...
	<div id="header">
		...
		<div id="profile" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="width:700px;">
				...
				<div class="modal-footer">
					<a href="account.php?id=<?php echo $fetch['customerid']; ?>"><input type="button" class="btn btn-success" name="edit" value="แก้ไขผู็ใช้งาน"></a>
	...
	<div class="nav">
		...
		<div class="nav1">
			<ul>
				...
				<li>|</li>
				<li><a href="football1.php" class="active" style="color:#111;">รองเท้าฟุตบอล</a></li>
				<li>|</li>
				<li><a href="running1.php">รองเท้าวิ่ง</a></li>
			</ul>
				<a href="cart.php"><button class="btn btn-inverse" style="right:1%; position:fixed; top:10%;"><i class="icon-shopping-cart icon-white"></i> ตะกร้าสินค้า</button></a>
		</div>
