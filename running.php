...
<body>
	<div id="header">
		...
		<div id="login1" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="width:400px;">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
				<h3 id="myModalLabel">โปรดล็อกอิน</h3>
			</div>
				<div class="modal-body">
					<form method="post">
					<center>
						<input type="email" name="email" placeholder="อีเมล์" style="width:250px;">
						<input type="password" name="password" placeholder="รหัสผ่าน" style="width:250px;">
					</center>
				</div>
			<div class="modal-footer">
		...
		<div id="signup" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="width:700px;">
				<div class="modal-header">
					...
					<form method="post">
						...
						<input type="text" name="address" placeholder="ที่อยู่" style="width:430px;"required>
						<input type="text" name="country" placeholder="ประเทศ" required >
						<input type="text" name="zipcode" placeholder="รหัสไปรษณีย์" required maxlength="4">
...
<div id="container">
	<div class="nav">
			 ...
			 <ul>
				...
				<li><a href="product.php"><i class="icon-th-list"></i>หมวดหมู่สินค้า</a>
	...
	<div class="nav1">
		<ul>
			<li><a href="product.php"> รองเท้าบาส</a></li>
			<li>|</li>
			<li><a href="football.php" > รองเท้าฟุตบอล </a></li>
			<li>|</li>
			<li><a href="running.php" class="active" style="color:#111;"> รองเท้าวิ่ง</a></li>
		</ul>
	</div>
...
<br />
	<div id="footer">
		<div class="foot">
			...
			<p style="font-size:25px;">ร้านขายรองเท้าผ้าใบออนไลน์
		</div>
