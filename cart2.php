...
<div id="container">
	<div class="nav">
			 <ul>
				...
				<li><a href="product.php"> 			 <i class="icon-th-list"></i>สินค้า</a></li>
...
?>
	...
	<a href='product.php' class='btn btn-inverse btn-lg'>เลือกสินค้าเพื่ม</a>
...
<br />
	<div id="footer">
		<div class="foot">
			...
			<p style="font-size:25px;">ร้านขายรองเท้าผ้าใบออนไลน์ <a href="https://code-projects.org/"> </a></p>
		</div>
